  ...
  return (
    <Container className="py-4">
      <Card className="mb-4 border">
        ...
        />
        <Card.Body>
          <Card.Title as="h3">{movie.title || movie.original_title}</Card.Title>
          <Card.Subtitle className="mb-2 text-muted"> Sortie le {movie.release_date?.split(', ')[1]}</Card.Subtitle>
